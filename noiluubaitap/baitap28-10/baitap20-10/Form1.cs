namespace baitap20_10
{
    public partial class Form1 : Form
    {
        ...
        {
            string maSinhVienTimKiem = textBox5.Text.Trim();
            bool found = false;
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                if (row.Cells["MaSinhVien"].Value?.ToString() == maSinhVienTimKiem)
                {
                    row.Visible = true;
                    found = true;
                }
            ...
            if (!found)
            {
                MessageBox.Show("Không tìm thấy mã sinh viên: " + maSinhVienTimKiem);
            }
        }
    }
}
